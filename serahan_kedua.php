...
// Ensure the user is logged in and has the role of 'pensyarah'
if (!isset($_SESSION['id']) || $_SESSION['role'] !== 'pensyarah') {
...
$sesi_query = "SELECT DISTINCT sesi FROM kursus WHERE pensyarah_id = ? ORDER BY sesi DESC";
...
$courses_query = "SELECT * FROM kursus WHERE pensyarah_id = ? AND sesi = ? ORDER BY semester ASC, kod_kursus ASC";
...
if ($serahan_kedua_date) {
    $deadline = new DateTime($serahan_kedua_date);
...
<body>
    ...
    <div class="container">
        ...
        <h1>Serahan Kedua<br>(Deadline: <?php echo htmlspecialchars($formatted_serahan_kedua_date); ?>)</h1>
            ...
            <div class="documents-container mt-4">
                ...
                <table class="table">
                    ...
                    <tbody>
                        ...
                        $doc_query = "SELECT * FROM dokumen WHERE kursus_id = ? AND serahan_no = 2 ORDER BY dokumen_id ASC";
                        ...
                        ?>
                            <tr>
                                ...
                                <td>
                                    <form action="upload_dokumen.php" method="POST" enctype="multipart/form-data" style="display:inline;">
                                        ...
                                        <input type="hidden" name="serahan_no" value="2">
                                        <input type="hidden" name="sesi" value="<?php echo htmlspecialchars($selected_sesi); ?>">
                                    ...
                                    <button class="delete-button" onclick="deleteDocument(<?php echo $doc['dokumen_id']; ?>)">Delete</button>
                                </td>
                                <td>
                                    <?php
                ...
                $pengesahan_query = "
                    ...
                    WHERE pk.kursus_id = ? AND pk.no_serahan = 2";
    ...
    <script>
        ...
        function deleteDocument(dokumenId) {
            if (confirm("Are you sure you want to delete this document?")) {
                window.location.href = `delete_dokumen.php?id=${dokumenId}`;
            }
        }
    </script>
</body>
